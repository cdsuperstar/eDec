        ...
        <form class="layout-padding" @submit.prevent="validateForm">
            ...
            <q-field
                ...
                <q-input
                        ...
                        :data-vv-as="$t('auth.email_confirmation')"
                        :stack-label="$t('auth.email_confirmation')">
                </q-input>
            </q-field>
            ...
            <q-field
                ...
                <q-input
                        ...
                        :stack-label="$t('auth.password_confirmation')">
                </q-input>
            </q-field>
            <!--
            ...
            <div class="row justify-center q-mt-md">
              ...
              <q-btn color="secondary" @click="$router.go('/')">{{$t('common.cancel')}}</q-btn>
            </div>
